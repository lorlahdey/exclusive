...
const Carousel = ({ initialActiveIndex = 1 }) => {
      ...
      >
        <div className="flex h-full">
          {slides.map((slide) => (
            <div
              key={slide.id}
              className="flex-shrink-0 w-full h-full snap-center flex flex-col lg:flex-row items-center justify-between px-14 py-9 bg-black text-white gap-y-8"
            >
              <div className="flex flex-col lg:w-1/2 gap-8">
                ...
                <button className="w-fit font-medium px-12 py-4 bg-[#00FF66] text-[#FAFAFA] text-[16px] leading-[24px] rounded">
                  {slide.buttonLabel}
                </button>
              </div>
              <Image
